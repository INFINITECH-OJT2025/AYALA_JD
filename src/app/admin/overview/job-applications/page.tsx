  ...
  return (
    ...
    <div className="grid grid-cols-1 md:grid-cols-[40%_60%] gap-6">
      ...
      <div className="bg-white dark:bg-black p-6 w-full rounded-lg shadow-lg">
        <h2 className="text-2xl font-bold mb-4 text-black dark:text-white text-center md:text-left">Create Job</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Input
              ...
              value={form.salary ? new Intl.NumberFormat("en-US").format(Number(form.salary.replace(/,/g, ""))) : ""}
              onChange={(e) => {
          ...
          <div className="space-y-4">
            <label className="block text-sm font-bold text-gray-700 dark:text-gray-100">Job Image</label>

            {/* Image Preview with Remove Button */}
            {imagePreview && (
              <div className="relative inline-block">
                <img src={imagePreview} alt="Selected Image" className="w-32 h-32 object-cover rounded-lg" />
                <button
                  type="button"
          ...
          <Button type="submit" className="w-full bg-black dark:bg-white text-white dark:text-black">
            Create Job
          </Button>
        </form>
      </div>
