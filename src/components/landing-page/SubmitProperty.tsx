...
import { Phone, MapPin, DollarSign, Home, CheckSquare, Car, Image as ImageIcon } from "lucide-react";
...
export function SubmitProperty() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-8 dark:bg-gray-800 bg-white shadow-xl rounded-lg mt-4 mb-4">
      <h2 className="text-2xl font-bold mb-6 text-start">Want To Sell Your Property?</h2>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <FormField control={form.control} name="unit_status" render={({ field }) => (
            <FormItem>
              <FormLabel><Car className="inline-block mr-2" />Unit Status</FormLabel>
          ...
          <FormField control={form.control} name="type_of_listing" render={({ field }) => (
            <FormItem>
          ...
          <Button type="submit" variant="success" className="w-full text-lg">Submit Property</Button>
        </form>
      </Form>
    </div>
  );
