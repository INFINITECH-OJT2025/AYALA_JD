...
export function MobileAppDownload() {
  ...
  const handleInstallPWA = async () => {
    ...
    if (!deferredPrompt) {
      alert(
        "PWA installation is not available. Try opening this page in a browser."
      );
      return;
    }
      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            Experience seamless property browsing, instant updates, and
            exclusive deals—right at your fingertips.
          </p>
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              ...
              <span className="text-gray-700 dark:text-gray-300">
                Search & explore properties anytime, anywhere
              </span>
            </div>
            <div className="flex items-center gap-3">
              <Download
              ...
              />
              <span className="text-gray-700 dark:text-gray-300">
                Easy application & investment tracking
              </span>
            </div>
            <div className="flex items-center gap-3">
              <Star
              ...
              />
              <span className="text-gray-700 dark:text-gray-300">
                Exclusive app-only deals & property previews
              </span>
            </div>
          </div>
