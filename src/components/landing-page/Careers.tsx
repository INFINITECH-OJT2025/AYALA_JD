    ...
    <section className="py-12 bg-gray-200 dark:bg-gray-800">
      <div className="max-w-6xl mx-auto px-6">
        ...
        {loading ? (
            ...
            >
              ...
              <CardContent className="flex-grow">
                <div className="flex items-center text-gray-500 dark:text-gray-400 text-sm">
                  <Briefcase className="w-4 h-4 mr-2" /> {job.category || "Uncategorized"}
                </div>
                <div className="flex items-center text-gray-500 dark:text-gray-400 text-sm">
                  <MapPin className="w-4 h-4 mr-2 text-blue-600 dark:text-blue-400" /> {job.location}
                </div>
                <div className="flex items-center text-gray-500 dark:text-gray-400 text-sm">
                  <Clock className="w-4 h-4 mr-2 text-green-600 dark:text-green-400" /> {job.type}
                </div>
                <div className="flex items-center text-gray-700 dark:text-gray-300 text-sm">
                  ...
                  <span className="text-green-700 dark:text-green-400 font-bold ml-1">
                    {job.salary ? `₱${Number(job.salary).toLocaleString("en-PH", { minimumFractionDigits: 2 })}` : "Not specified"}
                  </span>
                </div>
          ...
          <p className="text-center text-gray-600 dark:text-gray-300">No featured jobs available.</p>
        )}
