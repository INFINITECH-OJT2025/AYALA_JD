    ...
    <section className="py-12 px-6 lg:px-24 bg-gray-50 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto mb-8">
          Explore our top-quality real estate services designed to meet your needs.
        </p>
      </div>

      {loading ? (
        <p className="text-center text-gray-500 dark:text-gray-300">Loading services...</p>
      ) : error ? (
            ...
            <Card
              ...
              >
                ...
                {service.image && (
                  <div className="p-4">
                    <Image
                      src={service.image.startsWith("http") ? service.image : `/storage/service_images/${service.image}`}
                      alt={service.title}
                      width={500}
                      height={300}
        ...
        <p className="text-center text-gray-600 dark:text-gray-300">No services available.</p>
      )}
        ...
        <Dialog open={!!selectedService} onOpenChange={() => setSelectedService(null)}>
          <DialogContent className="max-w-2xl h-[80vh] flex flex-col">
            ...
            {selectedService.image && (
              <Image
                src={selectedService.image.startsWith("http") ? selectedService.image : `/storage/service_images/${selectedService.image}`}
            ...
            <div className="flex-1 overflow-y-auto max-h-[40vh] p-2">
              <p className="text-gray-700 dark:text-gray-300 text-justify">{selectedService.description}</p>
            </div>
          </DialogContent>
        </Dialog>
      )}
